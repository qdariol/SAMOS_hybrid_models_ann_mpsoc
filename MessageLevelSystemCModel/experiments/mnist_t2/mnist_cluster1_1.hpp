...
void MB0::Execute()
{
    for(int i = 0; i < num_iter; i++)
    {
        ...
        buff_hl1hl2 = this->WriteTokens(read_hl1hl2, write_hl1hl2, buff_hl1hl2, 1, 10, t_r_loop);

        //OUTPUTLAYER
        buff_hl2out = this->ReadTokens(read_hl2out, write_hl2out, buff_hl2out, 1, 10, t_r_loop);
